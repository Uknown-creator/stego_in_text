...
/// @brief Кодек, отображающий каждый байт (0..255) в слово из словаря.
///
/// Словарь читается из файла: одно слово на строку, не менее 256 уникальных
/// слов в кодировке UTF-8. Индекс слова в файле равен значению байта.
class StegoCodec {
   public:
